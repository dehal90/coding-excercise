...
The main file is the Main_Coding_Excercise.rb file (lib directory) and the rest of the folders in the directory
are just include files which it depends on.
